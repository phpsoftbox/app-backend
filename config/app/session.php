...
return [
    'driver'           => env('APP_SESSION_DRIVER', 'native'),
    'connection'       => env('APP_SESSION_CONNECTION', 'default'),
    'table'            => env('APP_SESSION_TABLE', 'sessions'),
    ...
    'secure'           => env('APP_SESSION_SECURE', 'always'),
